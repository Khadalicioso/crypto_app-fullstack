...
function displayTrendCoins(coins){
    ...
    coins.forEach(coin => {
        ...
        row.innerHTML = `
            ...
            <td class="${coinData.data.price_change_percentage_24h.usd >= 0 ? 'green' : 'red'}">${coinData.price_change_percentage_24h.usd.toFixed(2)}%</td>
        `;
...
function displayAssets(data){
    ...
    data.forEach(asset => {
        ...
        row.innerHTML = `
            ...
            <td class="${coin.price_change_24h >= 0 ? 'green' : 'red'}">${asset.price_change_percentage_24h.toFixed(2)}</td>
